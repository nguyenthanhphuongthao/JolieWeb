...
INSERT INTO `Config`( `groupcode`, `code`, `name`, `date01`) VALUES ('CATEGORY', 'Danh mục mỹ phẩm','Mỹ phẩm High-end',NOW());
INSERT INTO `Config`( `groupcode`, `code`, `name`, `date01`) VALUES ('CATEGORY', 'Danh mục mỹ phẩm','Chăm sóc da mặt',NOW());
INSERT INTO `Config`( `groupcode`, `code`, `name`, `date01`) VALUES ('CATEGORY', 'Danh mục mỹ phẩm','Trang điểm',NOW());
INSERT INTO `Config`( `groupcode`, `code`, `name`, `date01`) VALUES ('CATEGORY', 'Danh mục mỹ phẩm','Chăm sóc tóc và Da đầu',NOW());
INSERT INTO `Config`( `groupcode`, `code`, `name`, `date01`) VALUES ('CATEGORY', 'Danh mục mỹ phẩm','Chăm sóc cơ thể',NOW());
INSERT INTO `Config`( `groupcode`, `code`, `name`, `date01`) VALUES ('CATEGORY', 'Danh mục mỹ phẩm','Chăm sóc cá nhân',NOW());
INSERT INTO `Config`( `groupcode`, `code`, `name`, `date01`) VALUES ('CATEGORY', 'Danh mục mỹ phẩm','Nước hoa',NOW());
